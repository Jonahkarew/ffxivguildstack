...
class Profile extends Component {
    ...
    render() {
        ...
        return (
            <div style={gridRoot}>
                {/* test button for api route remove later */}
                <Button button color="primary" onClick={this.clickyBoi} style={buttonStyle}>this here clicky boy</Button>
                {/* ================================*************=================================== */}
