...
const fetchChar = async (req, res) => {
    ...
    try {
        ...
        let char = {
                ...
                dexterity: parseInt($$(".character__param__list tr td").eq(1).text()),
                vitality: parseInt($$(".character__param__list tr td").eq(2).text()),
                intelligence: parseInt($$(".character__param__list tr td").eq(3).text()),
                mind: parseInt($$(".character__param__list tr td").eq(4).text()),
                criticalHitRate: parseInt($$(".character__param__list tr td").eq(5).text()),
                determination: parseInt($$(".character__param__list tr td").eq(6).text()),
                directHitRate: parseInt($$(".character__param__list tr td").eq(7).text()),
                defense: parseInt($$(".character__param__list tr td").eq(8).text()),
                magicDefense: parseInt($$(".character__param__list tr td").eq(9).text()),
                attackPower: parseInt($$(".character__param__list tr td").eq(10).text()),
                skillSpeed: parseInt($$(".character__param__list tr td").eq(11).text()),
                attackMagicPotency: parseInt($$(".character__param__list tr td").eq(12).text()),
                healingMagicPotency: parseInt($$(".character__param__list tr td").eq(13).text()),
                spellSpeed: parseInt($$(".character__param__list tr td").eq(14).text()),
                tenacity: parseInt($$(".character__param__list tr td").eq(15).text()),
                piety: parseInt($$(".character__param__list tr td").eq(16).text()),
